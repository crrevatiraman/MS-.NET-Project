    ...
    public class CheckOutController : Controller
    {
        ...
        public async Task<IActionResult> OrderConfirmation()
        {
            ...
            if (session.PaymentStatus == "paid")
            {
                ...
                return RedirectToAction("Index", "Order"); // Redirect to order index or any other page
            }

            return RedirectToAction("Login", "Account"); // Payment failed, redirect to login page
        }
    }
}
